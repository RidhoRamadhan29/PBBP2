...
class Menu extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('success_message', '<div class="alert alert-success" role="alert">New menu added!</div>');
            redirect('menu');
        }
    }
    ...
    public function submenu()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('success_message', '<div class="alert alert-success" role="alert">New Submenu added!</div>');

            $activity = 'Add New Sub Menu';
    ...
    public function editmenu($menu_id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($getMenu->num_rows() < 1) {
                ...
                $this->session->set_flashdata('success_message', '<div class="alert alert-success" role="alert">Edit Menu Success!</div>');
                redirect('menu');
            } else {
                $this->session->set_flashdata('success_message', '<div class="alert alert-danger" role="alert">This Menu name is exist or same!</div>');
    ...
    public function deletemenu($menu_id)
    {
        ...
        $this->session->set_flashdata('success_message', '<div class="alert alert-danger" role="alert">' . $menu['menu'] . ' menu is deleted!</div>');
    ...
    public function editsub($submenu_id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('success_message', '<div class="alert alert-success" role="alert">Edit Submenu Success!</div>');

            $activity = 'Edit Sub Menu';
            $log_message = 'User Id' . $this->session->userdata('user_id') . ' dengan nama (' . $this->session->userdata('username') . ') telah melakukan aktivitas: ' . $activity;
            log_message('error', $log_message);
    ...
    public function deletesub($submenu_id)
    {
        ...
        $this->session->set_flashdata('success_message', '<div class="alert alert-danger" role="alert">' . $submenu['menu'] . ' Submenu is deleted!</div>');
        $activity = 'Edit Sub Menu';
        $log_message = 'User Id' . $this->session->userdata('user_id') . ' dengan nama (' . $this->session->userdata('username') . ') telah melakukan aktivitas: ' . $activity;
        log_message('error', $log_message);
